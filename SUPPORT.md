...
アカウント固有の内容、機密情報、非公開の相談は、以下の連絡先を使用してください。<br>
...
セキュリティ上の問題は公開 Issue に投稿しないでください。<br>
Do not report security issues in public GitHub issues.

詳細は [SECURITY.md](SECURITY.md) を確認してください。<br>
